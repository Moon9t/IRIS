# IRIS 0.5.0 Current Language Lock

This document captures the current ready-to-use IRIS language surface for the 0.5.0 build. It is the reference for examples, LSP/DAP support, editor grammar, installer dependency checks, and ML pipeline examples.
