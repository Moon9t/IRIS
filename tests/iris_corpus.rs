...
//!
//! **Most files assert nothing.** 96 of 139 print results without
...
const KNOWN_BROKEN: &[(&str, &str)] = &[
    ...
    ("test_methods.iris",
     "invalid IR, then the eval fallback crashes -- #51"),
    ("test_mod_min.iris",
     "parse error: uses syntax the compiler does not accept"),
...
const NEEDS_ASSERTIONS: &[&str] = &[
    ...
    "test_blanket_multi_type.iris",
    "test_borrow_checker.iris",
    "test_borrow_error.iris",
    "test_closure_types.iris",
    "test_conditional_compile.iris",
    "test_const_fn.iris",
    "test_const_generic.iris",
    "test_default_fields.iris",
    "test_defer.iris",
    "test_dict_literal.iris",
    "test_doc_comments.iris",
    "test_doc_inline.iris",
    "test_effect_handlers.iris",
    "test_effect_mask.iris",
    "test_effect_polymorphism.iris",
    "test_effects_basic.iris",
    "test_effects_handlers.iris",
    "test_effects_masks.iris",
    "test_effects_masks_strict_fail.iris",
    "test_effects_parse.iris",
    "test_error_propagation.iris",
    "test_exhaustiveness.iris",
    "test_exhaustiveness_full.iris",
    "test_exhaustiveness_simple.iris",
    "test_expressiveness.iris",
    "test_ext_bring.iris",
    "test_ext_full.iris",
    ...
    "test_features_11_14.iris",
    "test_for_by.iris",
    "test_for_destructure.iris",
    "test_generic_records.iris",
    "test_generic_set.iris",
    "test_heap_use.iris",
    "test_hkt_syntax.iris",
    "test_if_let.iris",
    "test_json_auto.iris",
    "test_list_ops.iris",
    "test_macros.iris",
    "test_map_entries.iris",
    ...
    "test_refine_fail.iris",
    "test_refutable_let.iris",
    "test_regex_extended.iris",
    "test_resume_handler.iris",
    "test_select.iris",
    "test_selective_imports.iris",
    ...
    "test_task_group2.iris",
    "test_tier2.iris",
    "test_tier4_features.iris",
    "test_trait_bounds.iris",
    "test_trait_if_else.iris",
