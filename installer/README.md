...
Download `IRIS-1.0.0-rc1-windows-x64-setup.exe` from the
...
```bash
sudo dpkg -i iris_1.0.0-rc1_x86_64.deb
# or
sudo apt install ./iris_1.0.0-rc1_x86_64.deb
```

**Fedora/RHEL (.rpm):**

```bash
sudo rpm -i iris-1.0.0-rc1-1.x86_64.rpm
# or
sudo dnf install ./iris-1.0.0-rc1-1.x86_64.rpm
```
...
```bash
sudo installer -pkg IRIS-1.0.0-rc1-macos-aarch64.pkg -target /
```
...
```powershell
Expand-Archive IRIS-1.0.0-rc1-windows-x86_64-portable.zip -DestinationPath C:\iris
$env:PATH += ";C:\iris"
```
...
Options:
- `--version 1.0.0-rc1` — set the version (default: 1.0.0-rc1)
...
**Linux .deb:**
```bash
bash installer/linux/build-deb.sh --version 1.0.0-rc1 --arch x86_64
```

**Linux .rpm:**
```bash
bash installer/linux/build-rpm.sh --version 1.0.0-rc1 --arch x86_64
```

**Linux AppImage:**
```bash
bash installer/linux/build-appimage.sh --version 1.0.0-rc1
```

**macOS .pkg:**
```bash
bash installer/macos/build-pkg.sh --version 1.0.0-rc1
```

**macOS .dmg:**
```bash
bash installer/macos/build-dmg.sh --version 1.0.0-rc1
```
